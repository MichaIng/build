...
# Enable USB DVB receiver drivers
function armbian_kernel_config__enable_usb_dvb() {
	opts_y+=('MEDIA_DIGITAL_TV_SUPPORT')
	opts_y+=('DVB_PLATFORM_DRIVERS')
	opts_m+=('DVB_AS102')
	opts_m+=('DVB_B2C2_FLEXCOP_USB')
	opts_m+=('DVB_USB_V2')
	opts_m+=('DVB_USB_AF9015')
	opts_m+=('DVB_USB_AF9035')
	opts_m+=('DVB_USB_ANYSEE')
	opts_m+=('DVB_USB_AU6610')
	opts_m+=('DVB_USB_AZ6007')
	opts_m+=('DVB_USB_CE6230')
	opts_m+=('DVB_USB_DVBSKY')
	opts_m+=('DVB_USB_EC168')
	opts_m+=('DVB_USB_GL861')
	opts_m+=('DVB_USB_LME2510')
	opts_m+=('DVB_USB_MXL111SF')
	opts_m+=('DVB_USB_RTL28XXU')
	opts_m+=('DVB_USB_ZD1301')
	opts_m+=('DVB_USB')
	opts_m+=('DVB_USB_A800')
	opts_m+=('DVB_USB_AF9005')
	opts_m+=('DVB_USB_AF9005_REMOTE')
	opts_m+=('DVB_USB_AZ6027')
	opts_m+=('DVB_USB_CINERGY_T2')
	opts_m+=('DVB_USB_CXUSB')
	opts_y+=('DVB_USB_CXUSB_ANALOG')
	opts_m+=('DVB_USB_DIB0700')
	opts_m+=('DVB_USB_DIBUSB_MB')
	opts_y+=('DVB_USB_DIBUSB_MB_FAULTY')
	opts_m+=('DVB_USB_DIBUSB_MC')
	opts_m+=('DVB_USB_DIGITV')
	opts_m+=('DVB_USB_DTT200U')
	opts_m+=('DVB_USB_DTV5100')
	opts_m+=('DVB_USB_DW2102')
	opts_m+=('DVB_USB_GP8PSK')
	opts_m+=('DVB_USB_M920X')
	opts_m+=('DVB_USB_NOVA_T_USB2')
	opts_m+=('DVB_USB_OPERA1')
	opts_m+=('DVB_USB_PCTV452E')
	opts_m+=('DVB_USB_TECHNISAT_USB2')
	opts_m+=('DVB_USB_TTUSB2')
	opts_m+=('DVB_USB_UMT_010')
	opts_m+=('DVB_USB_VP702X')
	opts_m+=('DVB_USB_VP7045')
	opts_m+=('DVB_TTUSB_BUDGET')
	opts_m+=('DVB_TTUSB_DEC')
	opts_m+=('SMS_USB_DRV')
}
